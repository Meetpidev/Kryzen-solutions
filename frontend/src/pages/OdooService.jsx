...
import OdooAcc from "../public/accounting-overview.png";
import OdooInv from "../public/Overview-Odoo-Inventory-App.png";
import OdooCrmImg from "../public/odoo-crm-app.png";
    ...
    <>
      ...
      <section className="w-full py-24">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <div>
              ...
              <div className="mt-3 w-20 h-1 bg-red-500">
        ...
        <div className="relative flex justify-center px-4">
            <div className="w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl bg-white flex items-center justify-center">
