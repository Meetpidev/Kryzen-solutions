...
import Mobile from "../public/ic_mobile.png";
import Software from "../public/ic_software.png";
import Web from "../public/ic_web.jpg";
import Mern from "../public/ic_mern.png";
import FullStack from "../public/ic_fullstack.png";
...
const PREMIUM_SERVICES = [
  ...
  },
  {
    ...
    icon: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeXsDXoA_8ex37StXnhFYaS7NRPBsxXsnFZQ&s",
  },
  {
    name: "Flutter App Development",
    icon: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYYAfz-KmOiY-JQEDNDF2brVLmDSxJG5To-A&s",
  },
  {
    name: "PHP Development",
    icon: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRczZI3ghLdEmTkBPVz8LQS064LMt4gz0q61Q&s",
  },
  {
    name: "Ai Animations & Automation",
    icon: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSW-DQxnhH9O3GEqb0AkQfPE_xj81BJuvlR5Q&s",
  },
  {
...
export default function PremiumServices() {
    ...
    return (
      <section className="bg-[#056288] py-12 px-4 w-full min-h-[80vh] flex flex-col items-center">
        ...
        <div className="bg-white rounded-2xl px-6 py-8 flex flex-col items-center shadow-md transition-transform hover:scale-105 w-full max-w-screen-md">
          <img src={service.icon} alt={service.name} className="icon-float h-16 w-16 mb-4" loading="lazy" decoding="async" />
  ...
  return (
    <section className="bg-[#056288] py-12 px-4 w-full min-h-[74vh] flex flex-col items-center">
      <h2 className="text-white text-4xl font-bold text-center mb-4 w-full max-w-screen-lg">
        Our Premium Services
      </h2>
      <p className="text-white text-center text-lg mb-10 max-w-screen-lg px-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 w-full max-w-[76rem]">
        {PREMIUM_SERVICES.map((service) => (
          <div key={service.name} className="bg-white rounded-2xl px-6 py-6 flex flex-row items-center shadow-md">
            <img src={service.icon} alt={service.name} className="icon-float h-12 w-12 mb-3" />
