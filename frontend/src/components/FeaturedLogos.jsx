            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center gap-4">
                    <input
                        ...
                        className="placeholder-gray-700 flex-1 max-w-xs px-4 py-3 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                    <input
                        type="email"
                    ...
                    <div className="flex flex-1 max-w-xs">
                        <span className="inline-flex items-center px-3 border border-r-0 border-gray-300 bg-white rounded-l-lg text-gray-600">
                            +91
                        </span>
                        <input
                            type="tel"
